INSERT INTO real_estate_agencies (id, name, iban) VALUES
    (10, 'Test Agency 1', '1111111111'),
    (20, 'Test Agency 2', '2222222222');

INSERT INTO users (id, username, cognito_sub) VALUES
...
INSERT INTO real_estate_agents (user_id) VALUES
    (20), -- agent1
    (40); -- agent2

INSERT INTO real_estate_managers (user_id) VALUES
    (30), -- manager1
    (50); -- manager2
...
INSERT INTO addresses (id, city, state, street, housenumber, location) VALUES
...
INSERT INTO insertions (id, description, address_id, uploader_id, agency_id, size, number_of_rooms, floor, has_elevator) VALUES
    (10, null, 10, 20, 10, 85.0, 3, 2, true),
    (20, null, 20, 30, 10, 120.0, 5, null, false),
    (30, null, 30, 40, 20, 60.0, 2, 5, true);

INSERT INTO insertion_tags (insertion_id, tag_id) VALUES
    (10, 10), -- Insertion 10 has tag 'Garden'
    (10, 20), -- Insertion 10 has tag 'Garage'
    (20, 20); -- Insertion 20 has tag 'Garage'

INSERT INTO insertions_for_sale (id, price) VALUES
    (10, 300000.0);

INSERT INTO insertions_for_rent (id, rent) VALUES
    (20, 1500.0),
    (30, 2500.0);
