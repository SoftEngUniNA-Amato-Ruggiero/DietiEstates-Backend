...
public interface InsertionForRentRepository extends BaseInsertionRepository<InsertionForRent> {
    ...
    @Transactional
    @Query("SELECT new it.softengunina.dietiestatesbackend.dto.insertionsdto.responsedto.InsertionSearchResultDTO(i.address.location, i.id) FROM InsertionForRent i " +
    ...
    Page<InsertionSearchResultDTO> search(@Param("req") SearchRequestForRentDTO req, Set<String> tags, Integer tagCount, Pageable pageable);
}
